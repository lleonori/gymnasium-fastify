...
describe("BookingDao", () => {
  ...
  //     const result = await bookingDao.findAll({}, { limit: 10, offset: 0 }, [
  //       ["id", "asc"],
  //     ]);
  ...
  //     const result = await bookingDao.findAll({}, { limit: 5, offset: 0 }, [
  //       ["id", "asc"],
  //     ]);
  //     expect(result.count).toBe(10);
  ...
  //     const result = await bookingDao.findAll(
  //       { mail: "user3@test.com" },
  //       { limit: 10, offset: 0 },
  //       [["id", "asc"]]
  //     );
  //     expect(result.count).toBe(1);
  //     expect(result.data[0].mail).toBe("user3@test.com");
  //   });
  ...
  //     );
  //     expect(result.count).toBe(1);
  //     expect(result.data[0].day).toBe("2024-05-12");
  //   });
  // });
